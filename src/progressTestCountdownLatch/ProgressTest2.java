package progressTestCountdownLatch;
...
public class ProgressTest2 extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        getButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                //con LAMBDA
                copyTask1.addEventHandler(WorkerStateEvent.WORKER_STATE_SUCCEEDED, new EventHandler<WorkerStateEvent>() {
                    @Override
